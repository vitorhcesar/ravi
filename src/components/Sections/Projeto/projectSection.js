    ...
    return (
        <section id='project-section'>
            <div className='section-title to-right'>
                <h1 className='normal'>O Projeto </h1>
            ...
            <div id='project-content'>
                ...
                <div className='card'>
                    ...
                    <div id='svg-content'>
                        <button onClick={() => goToPage('https://github.com/yondv')} className='svg-button'>
                        ...
                        <button onClick={() => goToPage('https://www.linkedin.com/in/v%C3%ADtor-hugo-tavares-pereira-a99435232/')} className='svg-button'>
